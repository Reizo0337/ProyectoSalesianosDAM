  ...
  <div class="view-container">
    <div class="header-section">
      <div class="title-box">
        ...
        <p>Seguimiento y gestión de pedidos realizados. <span class="result-count-inline">({{ filteredOrders.length }} resultados)</span></p>
      </div>
...
.create-btn {
  ...
  border: none; padding: 10px 20px; border-radius: 4px; font-weight: 600;
